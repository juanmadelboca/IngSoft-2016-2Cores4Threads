...
public class SeleccionView extends DJView{

	JComboBox<String> comboBox;
    BeatModelInterface BModel,QAdapter,HAdapter,modelElegido;
    QuestionModelInterface QModel;
    HeartModelInterface HModel;
    ControllerInterface controllerElegido;
	public SeleccionView(ControllerInterface controller,BeatModelInterface model) {
